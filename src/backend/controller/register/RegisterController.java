...
public class RegisterController implements IRegisterController {
    ...
    public void SignIn(ActionEvent e) throws IOException, SQLException {
        ...
        // Tạo đối tượng Users và truyền đến SelectRoleController
        ...
        user.setPassword(str_password); // Mật khẩu plain text sẽ được mã hóa sau
        user.setStatus(UserStatus.online);
        user.setCreatedAt(LocalDate.now());
        user.setDescription("No bio yet");

        // Chuyển sang SelectRoleController để chọn role
