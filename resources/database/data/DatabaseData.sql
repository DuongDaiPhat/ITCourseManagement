...
CREATE TABLE `categories` (
  ...
  `CATEGORYNAME` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `coursecategories` (
  ...
  CONSTRAINT `coursecategories_ibfk_1` FOREIGN KEY (`COURSEID`) REFERENCES `courses` (`COURSEID`) ON DELETE CASCADE,
  CONSTRAINT `coursecategories_ibfk_2` FOREIGN KEY (`CATEGORYID`) REFERENCES `categories` (`CATEGORYID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,2,'Phat','Duong Dai','iFatDuong','DuongDaiPhat2911@','0899492608','6451071058@st.utc2.edu.vn','Good boy','online','2025-04-04');
...
-- Dump completed on 2025-04-04 15:07:52
